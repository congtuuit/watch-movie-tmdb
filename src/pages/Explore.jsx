...
const Explore = () => {
  ...
  return (
    <>
      ...
      >
        <BsFillArrowUpCircleFill size={35} className="text-primary hover:brightness-75 transition duration-300" />
      </button>
      ...
      <div className="flex flex-col-reverse md:flex-row">
        ...
        <div className="flex-grow px-[2vw] pt-6">
          {!isMobile && (
            <div className="flex justify-between items-center mb-8">
              <h2 className="text-white text-3xl font-medium uppercase ">Find films that best fit you</h2>
        ...
        {isMobile && (
          <h2 className="text-white text-3xl font-medium uppercase ml-3 mt-3">Find films that best fit you</h2>
        )}
      </div>
    </>
  );
