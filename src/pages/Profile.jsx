...
const Profile = () => {
  ...
  const reAuthentication = async (type) => {
    ...
    <>
      ...
      {isShowPromptReAuthFor && (
        <>
          ...
          <BlackBackdrop onCloseBlackBackdrop={() => setIsShowPromptReAuthFor(undefined)} />
        </>
      )}
        ...
        <div className="flex-grow pt-7 md:pl-10 px-3">
          ...
          <div className="flex flex-col-reverse md:flex-row gap-8 md:gap-0 ">
            <div className="flex-grow">
              ...
              <p>If you signed in with Google or Facebook, you can't change your email and password.</p>

              <div className="mt-7 max-w-[600px] w-full flex flex-col gap-3">
                <Email
                  onShowPromptReAuthForEmail={() => setIsShowPromptReAuthFor("email")}
              ...
              <Password
                onShowPromptReAuthForPassword={() => setIsShowPromptReAuthFor("password")}
                isUpdatedPassword={isUpdatedPassword}
                setIsUpdatedPassword={setIsUpdatedPassword}
                newPasswordValueRef={newPasswordValueRef}
              />

              <DeleteAccount onShowPromptReAuthForDeleteAccount={() => setIsShowPromptReAuthFor("delete")} />
            </div>
            <ProfileImage />
          </div>
        </div>
