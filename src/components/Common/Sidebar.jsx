      ...
      >
        {!isMobile && (
          <Link to="/" className="flex items-center gap-3">
            <LazyLoadImage alt="Logo" src="/logo.png" effect="opacity" className="w-10 h-10" />
        ...
        <div className={`d-none text-white text-lg font-medium ${isSidebarActive ? "-mt-6" : "mt-12"}`}>MENU</div>
        ...
        <div className="mt-8 ml-4 flex flex-col gap-6">
          ...
          <Link
            to="/explore"
            className={`flex gap-6 items-center  ${
              location.pathname === "/explore" && "!text-primary border-r-4 border-primary font-medium"
            } hover:text-white transition duration-300`}
          >
          ...
          <Link
            to="/search"
            className={`flex gap-6 items-center  ${
              location.pathname === "/search" && "!text-primary border-r-4 border-primary font-medium"
            } hover:text-white transition duration-300`}
          >
            <BiSearch size={25} />
            <p>Search</p>
        ...
        <div className="text-white text-lg font-medium mt-12 d-none">PERSONAL</div>
        <div className="mt-8 ml-4 flex flex-col gap-6">
          <button
            onClick={() => personalPageHandler("/bookmarked")}
            className={`d-none flex gap-6 items-center  ${
              location.pathname === "/bookmarked" && "!text-primary border-r-4 border-primary font-medium"
            } hover:text-white transition duration-300`}
          >
          ...
          <button
            ...
            className={`d-none flex gap-6 items-center  ${
              location.pathname === "/history" && "!text-primary border-r-4 border-primary font-medium"
            } hover:text-white transition duration-300`}
          >
        ...
        <div className="text-white text-lg font-medium mt-12 d-none">GENERAL</div>
        <div className="mt-8 ml-4 flex flex-col gap-6">
          <button
            onClick={() => personalPageHandler("/profile")}
            className={`d-none flex gap-6 items-center  ${
              location.pathname === "/profile" && "!text-primary border-r-4 border-primary font-medium"
            } hover:text-white transition duration-300`}
          >
          ...
          {!currentUser && (
            <Link
              ...
              className="d-none flex gap-5 items-center"
            >
          ...
          {currentUser && (
            <button onClick={signOutHandler} className="d-none flex gap-5 items-center">
