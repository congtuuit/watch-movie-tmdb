...
const SignIn = ({ setIsShowSignInBox }) => {
  ...
  return (
    <>
      {currentUser && <ModalNotification type="success" message={"Sign in successfully"} />}
      {isLoading && (
      ...
      <div className="px-4 py-2 rounded-xl max-w-xl w-full min-h-[500px] text-white/70 tw-absolute-center">
        <div className="flex flex-col items-center mb-5">
          <div className="text-[50px] font-semibold mb-1 mx-auto">
            <div className="text-primary leading-none mb-4 text-center">Sign In To Moonlight</div>
          </div>
        ...
        <p className="text-xl flex gap-2 mt-32 justify-center">
          ...
          <button onClick={() => setIsShowSignInBox(false)} className="text-primary/90 underline">
            Sign Up
          </button>
        </p>
      </div>
