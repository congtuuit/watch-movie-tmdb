...
const Email = ({ onShowPromptReAuthForEmail, isUpdatingEmail, setIsUpdatingEmail, emailValueRef }) => {
      ...
      <div>
        ...
        {!isUpdatingEmail && (
          <div className="flex justify-between mt-1">
            ...
            <button className="hover:text-primary transition duration-300" onClick={() => setIsUpdatingEmail(true)}>
