...
const Password = ({ onShowPromptReAuthForPassword, isUpdatedPassword, setIsUpdatedPassword, newPasswordValueRef }) => {
  return (
    <>
      <ToastContainer />
      ...
      {isUpdatedPassword && (
        <>
          ...
          <BlackBackdrop onCloseBlackBackdrop={() => setIsUpdatedPassword(false)} />
        </>
      )}
