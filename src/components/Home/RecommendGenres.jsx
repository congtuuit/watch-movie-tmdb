...
const getRandomGenres = (genres) => {
  ...
  // const randomGenres = [] as { id: number; name }[];
...
const RecommendGenres = ({ currentTab }) => {
  ...
  //  as { id: number; name }[]
  const randomGenres = getRandomGenres(currentTab === "movie" ? data.movieGenres : data.tvGenres);
